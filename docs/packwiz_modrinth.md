...
* [packwiz modrinth add](packwiz_modrinth_add.md)	 - 通过 Modrinth URL、slug/项目 ID 或搜索添加项目
* [packwiz modrinth export](packwiz_modrinth_export.md)	 - 将当前整合包导出为 Modrinth 使用的 .mrpack 文件
