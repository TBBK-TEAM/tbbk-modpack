...
为指定的 shell 生成 packwiz 的自动补全脚本。
请参阅各子命令的帮助以了解如何使用生成的脚本。
...
* [packwiz completion bash](packwiz_completion_bash.md)	 - 为 bash 生成自动补全脚本
* [packwiz completion fish](packwiz_completion_fish.md)	 - 为 fish 生成自动补全脚本
* [packwiz completion powershell](packwiz_completion_powershell.md)	 - 为 powershell 生成自动补全脚本
* [packwiz completion zsh](packwiz_completion_zsh.md)	 - 为 zsh 生成自动补全脚本
