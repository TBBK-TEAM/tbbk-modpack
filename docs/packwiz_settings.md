...
* [packwiz settings acceptable-versions](packwiz_settings_acceptable-versions.md)	 - 管理整合包可接受的 Minecraft 版本。这必须是逗号分隔的 Minecraft 版本列表，例如 1.16.3,1.16.4,1.16.5
