...
将你的 Minecraft 和加载器版本迁移到更新的版本。

### 选项

| 选项 | 说明 |
|------|------|
| `-h, --help` | migrate 的帮助信息 |
...
* [packwiz migrate loader](packwiz_migrate_loader.md)	 - 将你的 mod 加载器版本迁移到更新的版本。
* [packwiz migrate minecraft](packwiz_migrate_minecraft.md)	 - 将你的 Minecraft 版本迁移到更新的版本。
